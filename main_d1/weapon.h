...
struct weapon_info
{
	...
	fix			damage_force;			//	Force of damage caused by weapon, used for missiles (not lasers) to apply to damage to things it did not hit [ISB] needed for shareware emulation
